...
const Profile7Model = require('../models/Profile7/Profile7Model');
const SelectedMenu7Model =require('../models/Profile7/SelectedMenu7')
const { User , validate } = require("../models/Profile7/User7");
const bcrypt = require("bcrypt");
const Joi = require("joi");
const Order = require('../models/Profile7/Order7');
const Orderhistory = require('../models/Profile7/Orderhistory7');
...
router.post('/create', (req, res) => {
  ...
  Profile7Model.create({ name, description, price, imgUrl })
...
router.put('/update/:id', (req, res)=> {
  const id = req.params.id;
  Profile7Model.findByIdAndUpdate({_id:id},{name:req.body.name, description:req.body.description, price:req.body.price, imgUrl:req.body.imgUrl})
...
router.delete('/delete/:id',(req,res) => {
  const id = req.params.id;
  Profile7Model.findOneAndDelete({_id:id})
...
router.post('/saveSelectedFood', (req, res) => {
  ...
  SelectedMenu7Model.create({ name, description, price, imgUrl })
    .then((selectedFood) => {
...
router.delete('/deleteSelectedFood/:id', (req, res) => {
  ...
  SelectedMenu7Model.findByIdAndDelete(id)
    .then(deletedItem => {
      if (!deletedItem) {
...
router.delete('/clearTable', (req, res) => {
  SelectedMenu7Model.deleteMany() // You missed the parentheses here
    .then(deletedItems => {
