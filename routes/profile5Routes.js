...
const Profile5Model = require('../models/Profile5/Profile5Model');
const SelectedMenu5Model =require('../models/Profile5/SelectedMenu5')
const { User , validate } = require("../models/Profile5/User5");
const bcrypt = require("bcrypt");
const Joi = require("joi");
const Order = require('../models/Profile5/Order5');
const Orderhistory = require('../models/Profile5/Orderhistory5');
...
router.post('/create', (req, res) => {
  ...
  Profile5Model.create({ name, description, price, imgUrl })
...
router.put('/update/:id', (req, res)=> {
  const id = req.params.id;
  Profile5Model.findByIdAndUpdate({_id:id},{name:req.body.name, description:req.body.description, price:req.body.price, imgUrl:req.body.imgUrl})
...
router.delete('/delete/:id',(req,res) => {
  const id = req.params.id;
  Profile5Model.findOneAndDelete({_id:id})
...
router.post('/saveSelectedFood', (req, res) => {
  ...
  SelectedMenu5Model.create({ name, description, price, imgUrl })
    .then((selectedFood) => {
...
router.delete('/deleteSelectedFood/:id', (req, res) => {
  ...
  SelectedMenu5Model.findByIdAndDelete(id)
    .then(deletedItem => {
      if (!deletedItem) {
...
router.delete('/clearTable', (req, res) => {
  SelectedMenu5Model.deleteMany() // You missed the parentheses here
    .then(deletedItems => {
