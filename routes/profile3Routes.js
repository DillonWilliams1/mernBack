...
const Profile3Model = require('../models/Profile3/Profile3Model');
const SelectedMenu3Model =require('../models/Profile3/SelectedMenu3')
const { User , validate } = require("../models/Profile3/User3");
const bcrypt = require("bcrypt");
const Joi = require("joi");
const Order = require('../models/Profile3/Order3');
const Orderhistory = require('../models/Profile3/Orderhistory3');
...
router.post('/create', (req, res) => {
  ...
  Profile3Model.create({ name, description, price, imgUrl })
...
router.put('/update/:id', (req, res)=> {
  const id = req.params.id;
  Profile3Model.findByIdAndUpdate({_id:id},{name:req.body.name, description:req.body.description, price:req.body.price, imgUrl:req.body.imgUrl})
...
router.delete('/delete/:id',(req,res) => {
  const id = req.params.id;
  Profile3Model.findOneAndDelete({_id:id})
...
router.post('/saveSelectedFood', (req, res) => {
  ...
  SelectedMenu3Model.create({ name, description, price, imgUrl })
    .then((selectedFood) => {
...
router.delete('/deleteSelectedFood/:id', (req, res) => {
  ...
  SelectedMenu3Model.findByIdAndDelete(id)
    .then(deletedItem => {
      if (!deletedItem) {
...
router.delete('/clearTable', (req, res) => {
  SelectedMenu3Model.deleteMany() // You missed the parentheses here
    .then(deletedItems => {
